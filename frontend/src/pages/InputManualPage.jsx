...
const InputManualPage = ({ onNavigate }) => {
  ...
  const getDataDosen = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        const dataDosen = response.data.map((item) => ({

          id: item.id,

          col1: item.nidn || '',

          col2: item.nama_dosen || '',

          col3: item.mata_kuliah
            ? item.mata_kuliah
                .map((mk) => mk.nama_mk)
                .join(', ')
            : '',
          ...
          mata_kuliah_ids: item.mata_kuliah
  ...
  */
  ...
  const getDataMataKuliah = () => {
    ...
    axios
      .get('http://127.0.0.1:8000/api/mata-kuliah')
      ...
      .then((response) => {
        ...
        const dataMK = response.data.map((item) => ({
          ...
          col5:
            item.kelas_perkuliahan &&
            item.kelas_perkuliahan.length > 0 &&
            item.kelas_perkuliahan[0].prodi
              ? `${item.kelas_perkuliahan[0].prodi.nama_prodi} - ${item.kelas_perkuliahan[0].prodi.jenjang}`
              : '',
  ...
  const getDataKelas = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setKelasPerkuliahan(response.data);
  ...
  */
  ...
  |
  | PENTING:
  | Sekarang semua grid menggunakan FR.
  | Jadi total kolom selalu mengikuti lebar tabel.
  |
  */
  ...
  const tabConfig = {
    ...
    */
    ...
    mk: {
      ...
      subtitle:
        'Tambahkan data mata kuliah secara manual',

      gridTemplate:
        '1fr 2.8fr 0.7fr 0.9fr 2.3fr 0.9fr',
    ...
    */
    ...
    ruangan: {
      ...
      subtitle:
        'Tambahkan data ruangan secara manual',

      gridTemplate:
        '1fr 0.7fr 1.5fr 1fr 1.2fr 0.7fr',
    ...
    */
    ...
    kelas: {
      ...
      gridTemplate:
        '1.4fr 1.4fr 0.8fr 0.8fr 1fr 1.5fr 1.1fr 0.7fr',
      ...
      inputs: [
        ...
        {
          key: 'semester_akademik_id',
          type: 'select',

          options: [
            'Pilih Semester',

            ...semesterAkademik.map(
              (item) =>
                `${item.tahun_akademik} - ${item.periode}`
            )
          ...
          (row) => {
            ...
            if (
              ...
              const selectedMK =
                mataKuliah.find(
                  (mk) =>
                    `${mk.nama_mk} - ${mk.prodi?.nama_prodi || ''}`
                    === value
                );
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            gridTemplateColumns:
              currentConfig.gridTemplate,

            textAlign: 'center'
          }}
        >

          {currentConfig.headers.map(
          (header, idx) => (
      ...
      {showGenerateModal && (
        ...
        <div className="generate-modal-overlay">
          ...
          <div className="generate-modal">
            ...
            <h3>
              Lanjut ke Generate Jadwal
            </h3>

            <p>
              Pastikan seluruh data mata kuliah,
              dosen, dan ruangan telah tersimpan
              sebelum melanjutkan ke proses generate
              jadwal.
            </p>
